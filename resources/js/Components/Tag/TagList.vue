            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr />
                        <div class="float-end">
                            <Link href="/TagSavePage?id=0" class="btn btn-success mx-3 btn-sm">
                                Add Tag
                            </Link>
                        </div>
                        ...
                        <div>
                            ...
                            <EasyDataTable
                                ...
                                <template #item-number="{ id, name }">
                                    <a class="btn btn-success mx-3 btn-sm" :href="`/TagSavePage?id=${id}`">Edit</a>
...
<script setup>
    ...
    const Item = ref(page.props.tags);

    const searchValue = ref();
    const DeleteClick = (id) => {
        let text = "Do you went to delete"
        if(confirm(text)===true){
            router.get(`/delete-tag/${id}`);
